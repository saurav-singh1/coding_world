...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!$conn) {
            ...
            $sql = "INSERT INTO `form` (`First name`, `Last Name`, `Father name`, `Mother name`, `Phone number`, `D.O.B`, `E-mail`, `Educational details`, `State`, `Coding language to learn`, `Resume`) VALUES ('$Firstname', '$LastName', '$Fathername', '$Mothername', '$Phonenumber', '$DOB', '$Email', '$Educationaldetails', '$State', '$Codinglanguagetolearn', '$Resume')";
    ...
    <center>
        <div id="extension">
            <marquee behavior="scroll" direction="left-right">“First, solve the problem. Then, write the code. Don't be a
                minimum Guy...” </marquee>
            <hr>
            ...
            <form action="/Saurav/Projectform.php" method="POST"><br>
                <div>
                ...
                <div>
                    ...
                    <a href="C:\Users\welcome\Dropbox\My PC (DESKTOP-QPSDD8R)\Documents\web development\submission.html" target="_blank"><button class="button" id="button1">
